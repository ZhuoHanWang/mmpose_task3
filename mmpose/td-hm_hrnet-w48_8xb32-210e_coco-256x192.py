...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        bbox_file=
        'D:/Datasets/coco/person_detection_results/COCO_val2017_detections_AP_H_56_person.json',
        data_mode='topdown',
...
test_evaluator = dict(
    ann_file='D:/Datasets/coco/annotations/person_keypoints_val2017.json',
    type='CocoMetric')
