...
def main():
    # 模型配置
    model_name = 'hrformer'  # 模型简称
    config = '/root/task3/mmpose/configs/spine_2d_keypoint/topdown_heatmap/spine/td-hm_hrformer-base_8xb32-200e_spine-256x256.py'
    checkpoint = '/root/task3/mmpose/work_dirs/td-hm_hrformer-base_8xb32-200e_spine-256x256/best_PCK@0.01_epoch_167.pth'
