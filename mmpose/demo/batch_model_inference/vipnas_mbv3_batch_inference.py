...
def main():
    # 模型配置
    model_name = 'vipnas_mbv3'  # 模型简称
    config = '/root/task3/mmpose/configs/spine_2d_keypoint/topdown_heatmap/spine/td-hm_vipnas-mbv3_8xb64-200e_spine-256x256.py'
    checkpoint = '/root/task3/mmpose/work_dirs/td-hm_vipnas-mbv3_8xb64-200e_spine-256x256/best_PCK@0.01_epoch_177.pth'
