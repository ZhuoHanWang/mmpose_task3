...
def main():
    # 模型配置
    model_name = 'hrnetv2'  # 模型简称
    config = '/root/task3/mmpose/configs/spine_2d_keypoint/topdown_heatmap/spine/td-hm_hrnetv2-w48_1xb16-200e_spine-256×256.py'
    checkpoint = '/root/task3/mmpose/work_dirs/td-hm_hrnetv2-w48_1xb16-200e_spine-256×256/best_PCK@0.01_epoch_57.pth'
