...
def main():
    # 模型配置
    model_name = 'hrnet'  # 模型简称
    config = '/root/task3/mmpose/configs/spine_2d_keypoint/topdown_heatmap/spine/td-hm_hrnet-w48_8xb32-200e_spine-256x256.py'
    checkpoint = '/root/task3/mmpose/work_dirs/td-hm_hrnet-w48_8xb32-200e_spine-256x256/best_PCK@0.01_epoch_122.pth'
