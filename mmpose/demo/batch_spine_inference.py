...
def process_single_image(img_path, estimator, visualizer, save_dir):
    """处理单张图片的函数"""
...
def main():
    ...
    for i, img_path in enumerate(image_files, 1):
        ...
        process_single_image(img_path, estimator, visualizer, save_dir)
    
    print("\nProcessing complete!")
    print(f"Results saved in:")
    print(f"- Visualizations: {save_dir}")
    print(f"- Cobb angles: /root/task3/mmpose/cobb/simcc/")
